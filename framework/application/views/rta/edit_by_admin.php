...
<div id="section_wrapper">
    ...
    <div id="section_wrapper_inner">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr><td class="padBtmTp2" nowrap="nowrap" width="200">RTA #:</td>
                <td class="padBtmTp2 padLf5"><b style="color: #777"><?php echo date('m-d-y', strtotime($rta->rta_no_date)), '.', $rta->rta_no_count, $rta->rta_no_flag?></b></td>
            </tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr><td class="padTp5" colspan="2">
                
                <div class="padBtm5">
                    <div style="border: 2px solid #CCC; padding: 10px 0 10px 0; background: #EFEFEF">
                        <table>
                            <tr><td style="padding-left: 7px"><b>Action</b>:</td></tr>
                            <tr><td><input type="radio" name="state" value="2" id="approve"<?php echo (($rta->state == 1) ? ' checked="checked"' : '')?> /> <label for="approve">Approve</label></td></tr>
                            <tr id="fields_approve">
                                <td style="padding-left: 25px">
                                <table cellpadding="0" cellspacing="0">
                                    <!--tr><td><span class="mandatory">*</span> Time/Batch: <input type="text" id="time" onkeypress="return GBL.numOnly(event)" value="<?php echo $rta->time?>" /> <span class="tip">i.e. 0800 (Military time).</span></td></tr-->
                                    <tr><td class="padTp2">
                                            <div class="fltLf"><span class="mandatory">*</span> Location: <?php echo $sbu_loc?></div>
                                            <div class="fltLf hidden padLf2" id="loc_other_wrapper"><input type="text" id="loc_other" maxlength="50" /></div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr><td class="padTp2">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td valign="top" align="right">Tentative date(s):</td>
                                                <td valign="top" style="padding-left: 5px">

                                                    <table cellpadding="0" cellspacing="0" id="tentative_dates_wrapper"></table>
                                                </td>
                            ...
                            <tr><td><input type="radio" name="state" value="1" id="cancel" /> <label for="cancel">Cancel</label></td></tr>
                            <tr id="fields_cancel"><td style="padding-left: 25px">Reason: <input type="text" id="cancel_reason" /></td></tr>
                        </table>
                    </div>
                </div>
                </td>
