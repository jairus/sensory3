...
<div id="section_wrapper">
    ...
    <div id="section_wrapper_inner">
        ...
        <div style="padding: 0px 0 5px 0; font-weight: bold">Step <span id="step_text">1</span> of 2</div>

        <table cellpadding="0" cellspacing="0" id="step1">
            <tr><td class="padBtmTp2" nowrap="nowrap" width="200">Date Filed:</td>
                <td class="padBtmTp2 padLf5"><b><?php echo $date_filed?></b> (Today)</td>
            </tr>
            ...
            <tr><td class="padBtmTp2" nowrap="nowrap">Approved by:</td>
                <td class="padBtmTp2 padLf5">
                    ...
                    <div class="fltLf hidden padLf2" id="approved_by_other_wrapper"><input type="text" id="approved_by_other" maxlength="50" /> <img src="<?php echo $this->config->item('XY')->DOCROOT?>media/images/tip.png" alt='Enter full name, separated by spaces. i.e. "<b>Niña Bay Buan</b>".<br /><br />Do not include second names and extensions such as: IV or Jr.<br /><br />Firstname, Middlename, and Lastname only.' /></div>
            ...
            <tr><td class="padBtmTp2" align="right" nowrap="nowrap"><span class="mandatory">*</span> <u>Specifics</u> <b>#1</b>:</td>
                <td class="padBtmTp2 padLf5" height="30">
                    ...
                    <div class="fltLf hidden padLf2" id="spec1_other_wrapper"><span id="spec1_other_label"><b>Others</b>: </span><input id="spec1_other" type="text" /> <img id="spec1_other_tip" alt="" src="<?php echo xy_doc_root()?>media/images/tip.png"></div>
                </td>
            </tr>
            <tr><td class="padBtmTp2" align="right" nowrap="nowrap"><span class="mandatory">*</span> <u>Specifics</u> <b>#2</b>:</td>
                <td class="padBtmTp2 padLf5" height="30">
                    ...
                    <div class="fltLf hidden padLf2" id="spec2_other_wrapper"><span id="spec2_other_label"><b>Others</b>: </span><input id="spec2_other" type="text" /> <img id="spec2_other_tip" alt="" src="<?php echo xy_doc_root()?>media/images/tip.png"></div>
                </td>
            </tr>
            <tr><td class="padBtmTp2" align="right" valign="top" nowrap="nowrap"><span class="mandatory">*</span> # of Testing dates:</td>
                <td class="padBtmTp2 padLf5" height="30" valign="top">
                    <input id="nof_testing_dates" type="text" value="<?php echo (($rta->nof_testing_dates > 0) ? $rta->nof_testing_dates : 1)?>" onkeypress="return GBL.numOnly(event)" />
            ...
            <tr><td class="padBtmTp2 padLf5"></td>
                <td class="padBtmTp2 padLf5" nowrap="nowrap">
                    <input style="width: auto; padding: 3px; font: 14px 'Lucida Grande'" type="button" value="Next" onclick="RTA_FORM.step(2)" />
                </td>
            </tr>
        </table>

        <table cellpadding="0" cellspacing="0" id="step2">
            ...
            <tr><td class="padBtmTp2 padLf5" align="right"><a href="javascript:RTA_FORM.step(1)" title="Step 1"><b>Back</b></a></td>
                <td class="padBtmTp2 padLf5" nowrap="nowrap"><input style="width: auto; padding: 3px; font: 14px 'Lucida Grande'" type="button" value="Submit this Form" onclick="RTA_FORM.submit()" /></td>
            </tr>
        </table>
    </div>
</div>