    ...
    EXAM.axl, {
        ...
        '_<?php echo $type_ctr?>' : function() {
                ...
                if(! EXAM.answers[<?php echo $ctr - 1?>].axl) {
                    ...
                    Popup.dialog({
                        title : 'ERROR',
                        message : '<div>Please select an answer for "Paired Preference item# <?php echo $ctr?>".</div>',
                        buttons: ['Okay', 'Cancel'],
                        width: '420px'
                    });
            ...
            <tr>
                ...
                if($nodiff == 'true') {
                    ...
                    <td style="text-align: center">
                        ...
                        <div style="width: 80px" title="same" id="<?php echo $type_ctr?>_choice_nodiff" style="display: inline-block; margin: 10px; padding: 10px; min-height: 38px; cursor: pointer; <?php echo $border?>">
