    ...
    EXAM.axl, {
        ...
        <?php echo $type_ctr?> : function() {
                ...
                if(! EXAM.answers[<?php echo $ctr - 1?>].axl) {
                    ...
                    Popup.dialog({
                        title : 'ERROR',
                        message : '<div>Please select an answer for "Same/Different item# <?php echo $ctr?>".</div>',
                        buttons: ['Okay', 'Cancel'],
                        width: '420px'
                    });
                ...
                foreach($codes as $code) {
                    ...
                    <td style="text-align: center">
                        ...
                        <div title="<?php echo $code?>" id="<?php echo $type_ctr?>_choice_<?php echo $code?>" style="display: inline-block; margin: 10px; padding: 10px; cursor: pointer; <?php echo $border?>">
                            <div style="font-size: 30px; font-weight: bold; text-transform: uppercase"><?php echo $code?></div>
                        </div>
