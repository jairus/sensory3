...
array_splice($code_choice, $position, 0, 'REFERENCE'); /* Insert the `REFERENCE` to it's assigned position. */
    ...
    EXAM.axl, {
        ...
        <?php echo $type_ctr?> : function() {
                ...
                if(! EXAM.answers[<?php echo $ctr - 1?>].axl) {
                    ...
                    Popup.dialog({
                        title : 'ERROR',
                        message : '<div>Please select an answer for "Duo-Trio item# <?php echo $ctr?>".</div>',
                        buttons: ['Okay', 'Cancel'],
                        width: '420px'
                    });
