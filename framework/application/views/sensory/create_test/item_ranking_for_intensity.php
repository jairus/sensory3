...
jQuery(function(){
    ...
    if(ranks != '' && codes != '') {
        ...
        jQuery('#'+ ITEM.type +'_rank_most').watermark('Strongest');
        jQuery('#'+ ITEM.type +'_rank_least').watermark('Weakest');
    }
